import { Calendar, MapPin, QrCode, Download, Share2, Info } from "lucide-react";
    ...
    <div className="bg-white rounded-3xl border border-gray-100 shadow-card overflow-hidden hover:shadow-xl transition-all duration-300 group flex flex-col md:flex-row">
      ...
      <div className="flex-1 p-6 flex flex-col justify-between">
        ...
        <div className="flex gap-3 border-t border-gray-50 pt-4">
          ...
          <button className="p-2.5 border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition-colors" title="Share NFT">
            <Share2 size={18}/>
          </button>
        </div>
      </div>
